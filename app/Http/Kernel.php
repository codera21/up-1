...
//        \App\Http\Middleware\HttpsProtocol::class
    ...
    protected $routeMiddleware = [
        ...
        'be.navigation' => \App\Http\Middleware\BackendNavigation::class,
        'be.breadcrumbs' => \App\Http\Middleware\BackendBreadcrumbs::class,
        'fe.navigation' => \App\Http\Middleware\FrontendNavigation::class,
        'fe.breadcrumbs' => \App\Http\Middleware\FrontendBreadcrumbs::class,
