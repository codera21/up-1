    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        if ($user = $this->user->create($data)) {
            ...
            Session::flash('success', 'An email has been sent to your mentioned email address for email confirmation. <br />Please click that link to confirm its your email address <br /> Please check your spam if you don’t see the activation email in your inbox');
