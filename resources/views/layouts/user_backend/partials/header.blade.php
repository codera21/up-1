                                ...
                                <ul class="nav" id="account-nav">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{ url('user/'.Auth::user()->username) }}"><i class="glyphicon glyphicon-user"></i>Profile</a></li>
                                            <li><a href="{{ route('user.account') }}"><i class="glyphicon glyphicon-cog"></i>Account Settings</a></li>
                                            <li>
