...
<link href="{{ asset('/backend/inspinia/css/plugins/datepicker/datepicker3.css') }}" rel="stylesheet" type="text/css"/>
<script src="{{ asset('/backend/inspinia/js/plugins/datepicker/bootstrap-datepicker.js') }}" type='text/javascript'></script>

<!-- Bootstrap Daterangepicker -->
<link href="{{ asset('/backend/inspinia/css/plugins/daterangepicker/daterangepicker-bs3.css') }}" rel="stylesheet" type="text/css"/>
<script src="{{ asset('/backend/inspinia/js/plugins/daterangepicker/daterangepicker.js') }}" type='text/javascript'></script>

<!-- Datatable -->
<link href="{{ asset('/backend/inspinia/css/plugins/dataTables/datatables.min.css') }}" rel="stylesheet">
<script src="{{ asset('/backend/inspinia/js/plugins/dataTables/datatables.min.js') }}"></script>
...
<!-- Bootstrap iCheck -->
<link href="{{ asset('/backend/inspinia/css/plugins/iCheck/custom.css') }}" rel="stylesheet">
<script src="{{ asset('/backend/inspinia/js/plugins/iCheck/icheck.min.js') }}"></script>
