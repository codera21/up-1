       ...
       @include('layouts.user_backend.flash')
        ...
        <div class="panel-body">
            <div class="ibox-content">
                <form action="{{route('testo.update',['post'=>$heavy->id])}}" id="manage-faq" method="" class="form-horizontal">
                    {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input type="name" name="name" class="form-control" id="exampleInputEmail1"
                                           aria-describedby="emailHelp" value="{{$heavy->name}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group container">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <textarea name="testomonial"  cols="80" rows="10">{{$heavy->testomonial}}</textarea>
                                </div>
                            </div>
                        </div>
                    </fieldset>
