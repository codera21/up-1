...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <input type="text" id="myInput" class="form-control" value="{{ asset('/register').'/'.$user }}"
        ...
        <div class="fb-share-button" data-href="{{asset('/register').'/'.$user  }}" data-layout="button_count"
        ...
        <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-size="large"
           data-url="{{asset('/register').'/'.$user}}" data-related="asdf" data-show-count="false">Tweet</a>
