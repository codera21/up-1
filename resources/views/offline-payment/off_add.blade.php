                ...
                <fieldset>
                    ...
                    <div class="form-group container">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="name" name="name_of_subscriber" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="form-group container">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="name" name="country" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="form-group container">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="name" name="payment_type" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="form-group container">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="name" name="bank_slip_no" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="form-group container">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="name" name="account_no" class="form-control" id="exampleInputEmail1"
                    ...
                    <div class="form-group container">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="name" name="amount_paid" class="form-control" id="exampleInputEmail1"
